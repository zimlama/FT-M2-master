...
// let spanCreatedBy = document.querySelector('#createdBy');
// spanCreatedBy.innerHTML = "Aplicación creada por: Leonardo";
// verison 0.2
document.querySelector('#createdBy').innerHTML = "Aplicación creada por: Leonardo";
